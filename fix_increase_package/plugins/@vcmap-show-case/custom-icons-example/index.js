import { VcsFormSection as y, VcsLabel as w, createToggleAction as S, ButtonLocation as C } from "../../../assets/ui.js";
import { VCol as x, VRow as d, VIcon as O } from "../../../assets/vuetify.js";
import { resolveComponent as c, createElementBlock as a, openBlock as g, createVNode as I, withCtx as M, Fragment as m, renderList as E, createBlock as k, createTextVNode as T, toDisplayString as t } from "../../../assets/vue.js";
const r = (N, o) => {
...
function Q(N, o, i, z, D, P) {
  const u = c("VcsLabel"), e = c("v-col"), s = c("VIcon"), l = c("v-row"), n = c("VcsFormSection");
  return g(), a("div", null, [
    I(n, { heading: "VIcon" }, {
      default: M(() => [
        (g(!0), a(m, null, E(z.icons, (j) => (g(), k(l, {
          "no-gutters": "",
          key: j.title
        }, {
          default: M(() => [
...
const v = /* @__PURE__ */ r(Y, [["render", Q]]), A = "@vcmap-show-case/custom-icon-tester", B = "1.0.0", p = "^6.0", L = {
  name: A,
  version: B,
  mapVersion: p
};
async function Z() {
  return {
    ...
    onVcsAppMounted(N) {
      ...
      N.navbarManager.add(
        { id: "custom-icons-example", action: o },
        L.name,
        C.TOOL
      ), this._destoryAction = [i];
    },
    destroy() {
