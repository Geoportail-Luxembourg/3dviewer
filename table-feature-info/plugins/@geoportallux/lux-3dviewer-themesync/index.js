...
const k = "@geoportallux/lux-3dviewer-themesync", M = "1.4.5", E = "^6.1", b = ["fr", "de", "en", "lb"];
function G(r) {
  return (r == null ? void 0 : r.split("/")[1]) || "png";
}
function U(r, t, n, a) {
  const d = t == null ? void 0 : t.legend_name, l = {
    lang: a,
    id: n,
    ...d && { name: d }
  };
...
function P(r, t, n, a, d, l, i) {
  var s, c, y, f, x, L, T, $, S, w, _, v;
  const o = a && a.type && !n.layers.some((e) => e.id === a.id) && a.name !== "wintermesh" && !a.time;
  if (o) {
    l && (a.type = l);
    let e = {
      id: a.id,
      ...
      properties: {
        ...
        ...((c = a.metadata) == null ? void 0 : c.legend_name) && {
          legend: [
            {
  ...
  t.luxGeonetworkUrl && o && ((_ = a.metadata) != null && _.metadata_id) && (u.infoUrl = `${t.luxGeonetworkUrl}/${D(r.locale)}/catalog.search#/metadata/${(v = a.metadata) == null ? void 0 : v.metadata_id}`), n.contentTree.push(u);
  function p(e) {
    return {
      layers: {
        [a.name]: {
          title: d[e][a.name] || a.name
        },
        ...n.i18n[0][e].layers
      }
    };
...
async function V(r, t, n) {
  ...
  n.some(
    (i) => {
      var o;
      return (o = a.layers) == null ? void 0 : o.some(
        (u) => u.name === i.name
      );
    }
...
function q(r) {
  ...
  return {
    ...
    async initialize(n) {
      const a = await fetch(
        r.luxThemesUrl
      ).then((s) => s.json()), { themes: d } = a, l = a.lux_3d.terrain_url, i = a.background_layers.map(
        (s) => ({
          ...s,
          type: "BaseLayer"
        })
        ...
        (s) => {
          var c, y;
          return ((c = s.metadata) == null ? void 0 : c.ol3d_type) || ((y = s.metadata) == null ? void 0 : y.display_in_switcher) === !0;
        }
      ).sort((s, c) => {
        var y, f;
        return (y = s.metadata) != null && y.ol3d_type ? -1 : (f = c.metadata) != null && f.ol3d_type ? 1 : 0;
      });
      o.unshift({
        id: -1,
        name: "basemap",
      ...
      const p = (await Promise.all(
        b.map(
          (s) => fetch(`${r.luxI18nUrl}/${s}.json?_t=${Date.now()}`).then(
            (c) => c.json()
          )
        )
      )).reduce(
      ...
      o.length > 0 && await t(n, o, l, p), await V(n, r, i);
    },
    onVcsAppMounted() {
    },
    /**
